...
public class MainActivity extends AppCompatActivity implements AdapterView.OnItemClickListener {
    ...
    public void initView() {
        ...
        requestParams.setUri("http://mapp.qzone.qq.com/cgi-bin/mapp/mapp_subcatelist_qq?yyb_cateid=-10&categoryName=%E8%85%BE%E8%AE%AF%E8%BD%AF%E4%BB%B6&pageNo=1&pageSize=20&type=app&platform=touch&network_type=unknown&resolution=412x732");
        Log.i(TAG, "net start: ");
        x.http().get(requestParams, new Callback.CommonCallback<String>() {
            ...
            public void onSuccess(String result) {
                ...
                List<Bean.AppBean> lists = new ArrayList<>();
                Gson gson = new Gson();
                        ...
                        builder.setSingleChoiceItems(Items, -1, new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialog, int which) {
                                if(which==0)
                                {
                                    ...
                                    builder.setMessage("现在检测到新版本，师傅更新");
                                    builder.setPositiveButton("确定", new DialogInterface.OnClickListener() {
                                        @Override
                                        public void onClick(DialogInterface dialog, int which) {
                                            targetPath = targetPath + System.currentTimeMillis() + ".apk";
                                            RequestParams request=new RequestParams();
                                            request.setUri(app.get(position).getUrl());
                                            // 设置下载保存路径
                                            request.setSaveFilePath(targetPath);
            ...
            case R.id.userGridView:
                ...
                if (position != 0 && position != 1) {
                    ...
                    if (moveImageView != null) {
                        TextView newTextView = (TextView) view.findViewById(R.id.tv_gridMore);
